...
<h2>Ingresa nueva línea de código</h2>
...
<form action="" method="POST">
  ...
  <fieldset>
    ...
    <?php
      $sql = "SELECT max(no_linea)+1 as new_linea FROM codigo WHERE id_backup=".$_GET['id_backup']." AND no_bloque=".$_GET['id_bloque'];
      $result = $conn->query($sql);
      if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $new_linea = $row['new_linea'];
      }
    ?>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <th style="width: 75%;"><input type="number" name="no_linea" value=<?php echo $new_linea;?> style="width: 100%;"></th>
        </tr>
        <tr>
